...
function getRetroColorScheme() {
    return {
        ...
        'background-color-mine-message-selected': '#bf6d00',
        'background-color-yours-message': '#829079',
        'background-color-yours-message-selected': '#a6b79b',
        'scroll-color': '#b9925e',
...
function getDarkColorScheme() {
    return {
        ...
        'background-color-mine-message-selected': '#075cb3',
        'background-color-yours-message': '#29739f',
        'background-color-yours-message-selected': '#008cd6',
        'scroll-color': '#1f4298',
...
function getLightColorScheme() {
    return {
        ...
        'background-color-mine-message-selected': '#cda271',
        'background-color-yours-message': '#2ab7ca',
        'background-color-yours-message-selected': '#006ec3',
        'scroll-color': '#1f4298',
        'background-color-side-menu-logo': '#1f4068',
